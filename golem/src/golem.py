...
if __name__ == '__main__':
    ...
    # Load dataset
    n, d = 1000, 100
    graph_type, degree = 'ER', 1    # ER2 graph
    B_scale = 1.0
    ...
    # Post-process estimated solution and compute results
    W_processed = postprocess(W_est, graph_thres=0.3)

    np.savetxt('W_est.csv', W_processed, delimiter=',')

    results = count_accuracy(B_true != 0, W_processed != 0)
    logging.info("Results (after post-processing): {}.".format(results))
